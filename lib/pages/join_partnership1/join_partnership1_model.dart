...
import 'join_partnership1_widget.dart' show JoinPartnership1Widget;
import 'package:flutter/material.dart';

class JoinPartnership1Model extends FlutterFlowModel<JoinPartnership1Widget> {
  ...
  // State field(s) for personalnum widget.
  FocusNode? personalnumFocusNode;
  TextEditingController? personalnumTextController;
  String? Function(BuildContext, String?)? personalnumTextControllerValidator;
  ...
  void dispose() {
    ...
    personalnumFocusNode?.dispose();
    personalnumTextController?.dispose();
